const content = docuemnt.getElementById("app-content")
const nav = docuemnt.getElementById("app-nav")
...
async function render(route) {
  ...
  try {
    ...
    content.innerHTML =
      res404 && res404.ok
        ? await res404.text()
        : '<article class="panel"><h2 class="panel_title">404</h2><p class="panel_text">No encontrada.</p></article>';
    setActive("");
  }
}
